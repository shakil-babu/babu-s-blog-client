...
লিস্টের `append` মেথডের সাহায্য নেওয়া হয়েছে যা এলিমেন্টকে খুব সহজেই `Queue` এ যুক্ত করে দিবে ।
...
`Queue` থেকে শেষ এলিমেন্ট নেওয়া যাবে tailElement মেথডের সাহায্যে ।
